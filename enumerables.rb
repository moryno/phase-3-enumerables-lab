...
def print_spicy_foods(spicy_foods)
  ...
  reformatted_food = spicy_foods.map do |food|
    "#{food[:name]} (#{food[:cuisine]}) | Heat Level: #{"🌶" * food[:heat_level]}"
  end
  puts reformatted_food
end
...
def get_spicy_food_by_cuisine(spicy_foods, cuisine)
  # your code here
  searched_food = spicy_foods.find{|food| food[:cuisine] == cuisine}
...
def sort_by_heat(spicy_foods)
  # your code here
  sorted = spicy_foods.sort{|a,b|  a[:heat_level] <=> b[:heat_level]}
...
def print_spiciest_foods(spicy_foods)
  # your code here
  reformatted_food = spicy_foods.select do |food|
